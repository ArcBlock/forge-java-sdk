...
public final class RevokeSwap {
  ...
  public  static final class RevokeSwapTx extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return forge_abi.RevokeSwap.internal_static_forge_abi_RevokeSwapTx_descriptor;
    }

    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return forge_abi.RevokeSwap.internal_static_forge_abi_RevokeSwapTx_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              forge_abi.RevokeSwap.RevokeSwapTx.class, forge_abi.RevokeSwap.RevokeSwapTx.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof forge_abi.RevokeSwap.RevokeSwapTx)) {
        return super.equals(obj);
      }
      forge_abi.RevokeSwap.RevokeSwapTx other = (forge_abi.RevokeSwap.RevokeSwapTx) obj;
    ...
    public static forge_abi.RevokeSwap.RevokeSwapTx parseFrom(
    ...
    public static forge_abi.RevokeSwap.RevokeSwapTx parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static forge_abi.RevokeSwap.RevokeSwapTx parseFrom(
    ...
    public static forge_abi.RevokeSwap.RevokeSwapTx parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static forge_abi.RevokeSwap.RevokeSwapTx parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static forge_abi.RevokeSwap.RevokeSwapTx parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(forge_abi.RevokeSwap.RevokeSwapTx prototype) {
    ...
    public static final class Builder extends
        ...
        forge_abi.RevokeSwap.RevokeSwapTxOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return forge_abi.RevokeSwap.internal_static_forge_abi_RevokeSwapTx_descriptor;
      }
      ...
      // Construct using forge_abi.RevokeSwap.RevokeSwapTx.newBuilder()
      private Builder() {
      ...
      public forge_abi.RevokeSwap.RevokeSwapTx getDefaultInstanceForType() {
        return forge_abi.RevokeSwap.RevokeSwapTx.getDefaultInstance();
      }

      public forge_abi.RevokeSwap.RevokeSwapTx build() {
        forge_abi.RevokeSwap.RevokeSwapTx result = buildPartial();
      ...
      public forge_abi.RevokeSwap.RevokeSwapTx buildPartial() {
        forge_abi.RevokeSwap.RevokeSwapTx result = new forge_abi.RevokeSwap.RevokeSwapTx(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof forge_abi.RevokeSwap.RevokeSwapTx) {
          return mergeFrom((forge_abi.RevokeSwap.RevokeSwapTx)other);
        } else {
      ...
      public Builder mergeFrom(forge_abi.RevokeSwap.RevokeSwapTx other) {
        if (other == forge_abi.RevokeSwap.RevokeSwapTx.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        forge_abi.RevokeSwap.RevokeSwapTx parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (forge_abi.RevokeSwap.RevokeSwapTx) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final forge_abi.RevokeSwap.RevokeSwapTx DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new forge_abi.RevokeSwap.RevokeSwapTx();
    }

    public static forge_abi.RevokeSwap.RevokeSwapTx getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\021revoke_swap.proto\022\tforge_abi\032\031google/p" +
      "rotobuf/any.proto\032\ntype.proto\"C\n\014RevokeS" +
