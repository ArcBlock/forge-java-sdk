...
import com.example.demo.handlers.ProductHandler
...
class ProductController : BaseController() {
    ...
    open fun createProduct(
      ...
      @RequestParam("pk") pkB58: String,
      @RequestParam("moniker") moniker: String
    ): String {
    ...
    fun buyProduct(@PathVariable id: String, address: String, sk: String, pk: String): String {
        ...
        val response = Utils.multiSig(tx, Base58Btc.decode(sk), Base58Btc.decode(pk), address, appDid, forge)
